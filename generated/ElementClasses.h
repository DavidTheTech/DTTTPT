...
class Element_FOAM: public Element
{
public:
	Element_FOAM();
	virtual ~Element_FOAM();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_COLNT: public Element
{
public:
	Element_COLNT();
	virtual ~Element_COLNT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_SCLNT: public Element
{
public:
	Element_SCLNT();
	virtual ~Element_SCLNT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_SFOAM: public Element
{
public:
	Element_SFOAM();
	virtual ~Element_SFOAM();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_DUPLQ: public Element
{
public:
	Element_DUPLQ();
	virtual ~Element_DUPLQ();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_MGNT: public Element
{
public:
	Element_MGNT();
	virtual ~Element_MGNT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_HACID: public Element
{
public:
	Element_HACID();
	virtual ~Element_HACID();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_SHLNT: public Element
{
public:
	Element_SHLNT();
	virtual ~Element_SHLNT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_HOLNT: public Element
{
public:
	Element_HOLNT();
	virtual ~Element_HOLNT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_ELEVA: public Element
{
public:
	Element_ELEVA();
	virtual ~Element_ELEVA();
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_CONVE: public Element
{
public:
	Element_CONVE();
	virtual ~Element_CONVE();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_ALUM: public Element
{
public:
	Element_ALUM();
	virtual ~Element_ALUM();
	
};

class Element_MGNM: public Element
{
public:
	Element_MGNM();
	virtual ~Element_MGNM();
	
};

class Element_WCMT: public Element
{
public:
	Element_WCMT();
	virtual ~Element_WCMT();
	
};

class Element_DCMT: public Element
{
public:
	Element_DCMT();
	virtual ~Element_DCMT();
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_PCMT: public Element
{
public:
	Element_PCMT();
	virtual ~Element_PCMT();
	static int update(UPDATE_FUNC_ARGS);
};

class Element_CCMT: public Element
{
public:
	Element_CCMT();
	virtual ~Element_CCMT();
