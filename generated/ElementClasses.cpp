...
std::vector<Element> GetElements()
{
	...
	elements.push_back(Element_FOAM());
	elements.push_back(Element_COLNT());
	elements.push_back(Element_SCLNT());
	elements.push_back(Element_SFOAM());
	elements.push_back(Element_DUPLQ());
	elements.push_back(Element_MGNT());
	elements.push_back(Element_HACID());
	elements.push_back(Element_SHLNT());
	elements.push_back(Element_HOLNT());
	elements.push_back(Element_ELEVA());
	elements.push_back(Element_CONVE());
	elements.push_back(Element_ALUM());
	elements.push_back(Element_MGNM());
	elements.push_back(Element_WCMT());
	elements.push_back(Element_DCMT());
	elements.push_back(Element_PCMT());
	elements.push_back(Element_CCMT());
	return elements;
}
